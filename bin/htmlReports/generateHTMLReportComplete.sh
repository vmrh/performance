...
# Get JTL_FILE name
HTML_FILE="${JTL_FILE}_Without_Redirections_Complete.html"
...
java ${JVM_ARGS} -classpath "${JMETER_DIR}/lib/xalan-2.7.1.jar:${JMETER_DIR}/lib/serializer-2.7.1.jar" org.apache.xalan.xslt.Process -IN "${JTL_FILE}" -XSL "${BASE_DIR}/xsl/jmeter-complete.xsl" -OUT "${HTML_FILE}"
